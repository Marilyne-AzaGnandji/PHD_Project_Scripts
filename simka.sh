...
## create output folders# We want to create 3 directory containing our data (paired and reads)
cd $HOME/Bureau/marilyne/PhD_Thesis/SAMA_12_first_10k_reads 
